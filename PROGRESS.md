...
| 6 | 13 | **тройният преглед хвана грешен отговор, броен за успех** | 460/460 ✓ | **PASS · exit 0** · 82 мутации | *(в ход)* | — |
...
| Стъпка | Харчи ли |
|---|---|
| нов кръг на тримата **върху поправките** | не |
| **третото пускане** | **да — иска думата `харчи`, след съгласие** |
