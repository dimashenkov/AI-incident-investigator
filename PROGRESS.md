...
| 6 | 14 | **третото живо пускане · петте минаха** · $0.0057 | 462/462 ✓ | **PASS · exit 0** · 84 мутации | *(в ход)* | — |
...
| Стъпка | Харчи ли |
|---|---|
| нов кръг на тримата върху поправките в подканите | не |
| **четвъртото пускане** | **да — иска думата `харчи`, след съгласие** |
