...
| 6 | 15 | **четвъртото пускане · нула грешни** · $0.0049 | 471/471 ✓ | **PASS · exit 0** · 90 мутации | *(в ход)* | — |
...
| Стъпка | Харчи ли |
|---|---|
| нов кръг на тримата върху нормализацията | не |
| **петото пускане** | **да — иска думата `харчи`, след съгласие** |
