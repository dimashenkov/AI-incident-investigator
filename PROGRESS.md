...
| 3 | 5 | `unknown` не минава за „изостанал"; печатът е затворена форма | 409/409 ✓ | **PASS · exit 0** · 57 мутации | **commit** | ✅ |
...
|---|---|---|
| provider на **данни** | откъде идват Kubernetes, логове, метрики | един · **вторият се строи**, вж. долу |
