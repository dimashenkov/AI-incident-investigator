...
| 6 | 10 | прескачането се чете от документа; `Conclude` иска този пуск | 452/452 ✓ | **PASS · exit 0** · 78 мутации | **commit** | ✅ |
...
| Стъпка | Харчи ли |
|---|---|
| **петте сценария наново, с поправките** | **да — иска думата `харчи`** |
