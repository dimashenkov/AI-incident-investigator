...
| 6 | 18 | „без симптом" ≠ „нищо"; конфигурацията се докладва просто | 477/477 ✓ | **PASS · exit 0** · 95 мутации | **и двамата: proceed** | — |
...
| Стъпка | Харчи ли |
|---|---|
| **шестото пускане** | **да — иска думата `харчи`, след съгласие** |
| валидатор за `must_cite` | не · **отказано нарочно**, вж. долу |
