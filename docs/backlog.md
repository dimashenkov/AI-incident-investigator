...
* **Как n8n Cloud стига до Grok.** Днес Grok се вика като CLI на тази машина
  (`grok -p`), което n8n Cloud (отдалечен) не може. Иска xAI API + credential в n8n,
  който **собственикът създава** (агентът няма право да въвежда ключове). Дали този
  API е покрит от абонамента или е metered — **непроверено**; ако е metered, това е
  нов billing път и всяко живо пускане е `харчи`.
