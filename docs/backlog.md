...
| 4 ✅ | **k=3 под set `2c121d3550c3` за другите 11 сценария** (ГОТОВО 2026-09-14: 33 пускания, baseline вече 15 сценария, 0 sticky, 12 на k=3 + 3 на k=2) | без това keep-rule-ът пази само 4 имена; поправка за `node-not-ready` не може да се **задържи** | ~33 живи пускания; HTTP 524; gpt-5 temperature default 1 | S / L | **да · харчи** |
